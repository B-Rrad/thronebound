...
Primary request: create the illustrated portrait art for Achilles.
Scene/backdrop: mythic Greek setting with restrained environmental storytelling.
Subject: Achilles; A radiant unstoppable warrior in bright heroic armor, spear-forward and mid-stride, with overwhelming momentum and battlefield confidence.
...
Materials/textures: include emblem cues from spearpoint over a sunburst shield.
Text (verbatim): "Add one attack card regardless of rank (play with card)."
