...
Primary request: create the illustrated portrait art for Athena.
Scene/backdrop: mythic Greek setting with restrained environmental storytelling.
Subject: Athena; A calm armored goddess with owl and aegis motifs, poised as a strategic protector, projecting clarity, wisdom, and exacting defense.
...
Materials/textures: include emblem cues from owl above a crested helm.
Text (verbatim): "Cancel one non-crown attack (standalone)."
